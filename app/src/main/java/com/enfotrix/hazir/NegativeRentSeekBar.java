...
public class NegativeRentSeekBar extends androidx.appcompat.widget.AppCompatSeekBar {

    protected int minimumValue = 0;
    protected int maximumValue = 0;
    protected OnSeekBarChangeListener listener;

    public NegativeRentSeekBar(Context context){
        super(context);
        setUpInternalListener();
    }

    public NegativeRentSeekBar(Context context, AttributeSet attrs){
        super(context, attrs);
        setUpInternalListener();
    }

    public NegativeRentSeekBar(Context context, AttributeSet attrs, int defStyle){
