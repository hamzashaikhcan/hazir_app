...
public class ModelCarSearch {
    ...
    public ModelCarSearch(int id, String driver_id, String car_model, String car_make, String model_year, String car_assembly, String engine_capacity,
                          String body_color, String between_cities, String registration_city, String pickup_city, String car_no, String driver_availability,
                          String car_mileage, String car_rent, String description, String insured, String car_seats, String car_type, String car_status,
                          String state, String car_tranmission, String image, String phone_no) {
        this.id = id;
